...
describe('loginSelenium', function () {
  ...
  it('Verificar cadastro acadêmico', async function () {
    ...
    await driver.findElement(By.css(".list-inline > .dropdown > .dropdown-menu > .ng-scope:nth-child(1) > .ng-binding")).click();
    await driver.sleep(5000);
